        ...
        window.onresize = (event) => {
            ...
            if (this.model) {
              const scalePreset = {
                ...
                sdvx:0.65,
                chackChr:(cname)=>{
                  return cname.toLowerCase().includes('rasis')?'sdvx':'azureLane';
                }
              }
              console.log(this.chrName)
                this.model.position = new PIXI.Point((width * 0.5), (height * 0.5));
                let scl = 1;
                scl = scalePreset[scalePreset.chackChr(this.chrName)];
                this.model.scale = new PIXI.Point((this.model.position.x * scl), (this.model.position.x * scl));
